...
public class PolynomialTest {
    ...
    public void plus_Test(){
        ...
        assertEquals(polynomial1.plus(polynomial2), polynomial3);
    }
    ...
    public void minus_Test(){
        ...
        assertEquals(polynomial1.minus(polynomial2), polynomial3);
    }
    ...
    public void differentiate_Test(){
        ...
        assertEquals(polynomial.differentiate(2), polynomial_dif);
    }
}